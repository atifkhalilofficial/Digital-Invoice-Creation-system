...
export default function InvoiceEdit() {
  ...
  if (loading) return (
    <div className="min-h-screen page-bg">
      <Navbar showBack backTo="/invoices" backLabel="Back to Invoices" />
      <p className="text-slate-500 p-8">Loading invoice...</p>
    </div>
  );
  ...
  return (
    <div className="min-h-screen page-bg">
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        {/* Page title with invoice number */}
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-slate-800 dark:text-white">
            Edit Invoice
          </h2>
          <span className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950 px-3 py-1 rounded-full border border-indigo-200 dark:border-indigo-800">
            Editing invoice
          </span>
        </div>
