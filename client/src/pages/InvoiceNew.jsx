...
export default function InvoiceNew() {
  ...
  const handleSubmit = async (status, sendEmail = false) => {
    setError("");
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="text-sm font-semibold px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors cursor-pointer border-none"
          >
